# LSP5004 V45 — Professional Fast AACR2 Catalogue Card Engine

V45 is the professional fast catalogue-card build for LSP5004.
...
The PDF filename and deployed server version are also V45.


## V45 stability/layout fix
