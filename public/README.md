# LSP5004 V48 — Professional Fast AACR2 Catalogue Card Engine

V48 is the professional fast catalogue-card build for LSP5004.
...
The PDF filename and deployed server version are also V48.


## V48 stability/layout fix
