...
function render(r){
 ...
 $("status").textContent=r.error?`${r.provider||"AACR2 engine"}\n${r.error}`:`${r.provider||"AACR2 automatic catalogue engine"} — complete entry set prepared.`;
}
