...
const VERSION = "V24-AACR2-REAL-ENTRY-ENGINE";
...
function normalizeResult(raw, question, section, materialType){
  ...
  if(promptLeak || placeholderLeak || !mainHasRealContent || looksLikeInstructionOnly(q) || !r.cards.some(c=>/^MAIN ENTRY$/i.test(c.entryType))){
...
app.post("/generate-pdf",(req,res)=>{
  ...
  res.setHeader("Content-Disposition",'attachment; filename="LSP5004-AACR2-Catalogue-Cards-V24.pdf"');
  doc.pipe(res);
