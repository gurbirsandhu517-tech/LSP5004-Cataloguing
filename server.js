...
const VERSION = "V41-AACR2-TRADITIONAL-CARD-LAYOUT";
...
function fieldIndent(line,index){
  ...
  if(/^Tracing:/i.test(s)) return 0;
  if(/^Subjects?:/i.test(s)) return 0;
  // AACR2 catalogue-card paragraph fields begin at the second text indentation.
  return 4;
}
...
app.post("/generate-pdf",(req,res)=>{
  ...
  res.setHeader("Content-Disposition",'attachment; filename="LSP5004-AACR2-Catalogue-Cards-V41.pdf"');
  doc.pipe(res);
