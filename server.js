...
const VERSION = "V19-AACR2-FAST-GEMINI-ALL-ENTRIES-PDF-FIX";
...
function parseSerialQuestion(q, materialType){
  ...
  if(/catalogue|cataloguing|following serial|question/i.test(titleClause) && /:\s*/.test(titleClause)) titleClause=titleClause.split(/:\s*/).pop().trim();
