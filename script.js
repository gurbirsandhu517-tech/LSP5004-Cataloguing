...
function buildEntry() {
  ...
  let subject = "Not generated from copyrighted Sears text. Verify the appropriate authorized subject heading against your permitted reference source.";
  let access = responsibility ? responsibility : "No creator/access point supplied.";
  let verification = `Material type identified as: ${type}. Description assembled only from supplied fields. Detailed AACR2 verification is still required.`;
